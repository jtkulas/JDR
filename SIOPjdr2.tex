...
Perhaps to a Hotelling's T across knowledge and service?
...
\midrule
\endhead
1. absorption & - &  &  &  &  &  &  & 3.80 & 0.80\\
2. vigor & .66*** & - &  &  &  &  &  & 4.10 & 0.87\\
3. dedication & .63*** & .66*** & - &  &  &  &  & 4.23 & 1.14\\
4. cognitive & .76*** & .78*** & .89*** & - &  &  &  & 3.94 & 0.86\\
5. affective & .80*** & .83*** & .85*** & .83*** & - &  &  & 3.96 & 1.05\\
6. behavioral & .80*** & .77*** & .74*** & .70*** & .75*** & - &  & 4.25 & 0.79\\
7. burnout & -.22*** & -.43*** & -.29*** & -.37*** & -.37*** & -.22*** & - & 3.04 & 0.87\\
8. stress & -.14*** & -.40*** & -.25*** & -.30*** & -.31*** & -.18*** & .70*** & 2.59 & 0.97\\
\bottomrule
\addlinespace
\insertTableNotes
\end{longtable}
